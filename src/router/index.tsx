...
import {root, buyBTC, sellBTC, account, wallet, support, overview, trades, disputes, offers, team, tradeHistory} from './routes';
        ...
        <Switch>
          ...
          <Route path={`${sellBTC}`}>
              ...
              <Switch>
                ...
                <Route component={TradesScreen} exact path={`${sellBTC}${trades}/:chatId`} />
